...
import type { AmbientLightDocumentPF2e, MeasuredTemplateDocumentPF2e, RegionBehaviorPF2e, RegionDocumentPF2e, ScenePF2e, TileDocumentPF2e, TokenDocumentPF2e } from "./module/scene/index.ts";
import type { ActorDeltaPF2e } from "./module/scene/token-document/actor-delta.ts";
...
import type { CheckPF2e } from "./module/system/check/index.ts";
import type { ConditionManager } from "./module/system/conditions/manager.ts";
import type { EffectTracker } from "./module/system/effect-tracker.ts";
import type { ModuleArt } from "./module/system/module-art.ts";
import type { Predicate } from "./module/system/predication.ts";
import type { CustomDamageData, HomebrewTag, HomebrewTraitSettingsKey, LanguageSettings } from "./module/system/settings/homebrew/index.ts";
import type { TextEditorPF2e } from "./module/system/text-editor.ts";
import type { sluggify } from "./util/index.ts";
