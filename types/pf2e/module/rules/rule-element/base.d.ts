...
import { DamageDicePF2e, ModifierPF2e, StatisticModifier } from "types/pf2e/module/actor/modifiers.ts"
 ...
 */
declare abstract class RuleElementPF2e<TSchema extends RuleElementSchema = RuleElementSchema> extends DataModel<
  ItemPF2e<ActorPF2e>,
  TSchema
> {
  #private
