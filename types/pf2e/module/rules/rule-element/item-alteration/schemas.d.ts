import type { ItemSourcePF2e, ItemType } from "types/pf2e/module/item/data/index.ts"
import { ItemPF2e } from "types/pf2e/module/documents.ts"
...
declare const ITEM_ALTERATION_VALIDATORS: {
  "ac-bonus": ItemAlterationValidator<{
    ...
    mode: StringField<
      "override" | "upgrade" | "add" | "remove" | "subtract" | "downgrade",
      "override" | "upgrade" | "add" | "remove" | "multiply" | "subtract" | "downgrade",
      true,
      false,
      false
    >
  ...
  hardness: ItemAlterationValidator<{
    itemType: StringField<
      "armor" | "consumable" | "book" | "backpack" | "equipment" | "treasure" | "weapon",
      ItemType,
      true,
      false,
      false
