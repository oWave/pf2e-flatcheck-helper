...
import { ActionType } from "types/pf2e/module/item/data/base.ts"
...
declare class CompendiumBrowser extends Application {
  ...
  openActionTab(options: { types?: ActionType[]; categories?: ActionCategory[]; traits?: ActionTrait[] }): Promise<void>
