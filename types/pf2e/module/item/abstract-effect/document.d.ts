...
import type { AfflictionSource, AfflictionSystemData } from "../affliction/data.ts";
import type { ConditionSource, ConditionSystemData } from "../condition/data.ts";
import type { EffectSource, EffectSystemData } from "../effect/data.ts";
