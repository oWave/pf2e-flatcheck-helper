...
import { ItemSourcePF2e, ItemSummaryData } from "types/pf2e/module/item/data/index.ts"
...
import { MeasuredTemplatePF2e } from "types/pf2e/module/canvas/index.ts"
import { ChatMessagePF2e, ItemOriginFlag } from "types/pf2e/module/chat-message/index.ts"
import { OneToTen, ZeroToTwo } from "types/pf2e/module/data.ts"
...
import { DamageRollContext, SpellDamageTemplate } from "types/pf2e/module/system/damage/types.ts"
...
declare class SpellPF2e<TParent extends ActorPF2e | null = ActorPF2e | null> extends ItemPF2e<TParent> {
  ...
  getRollData(rollOptions?: { castLevel?: number | string }): NonNullable<EnrichHTMLOptions["rollData"]>
