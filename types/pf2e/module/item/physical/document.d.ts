...
import { ItemPF2e, type ContainerPF2e } from "../index.ts";
import type { ItemSourcePF2e, PhysicalItemSource, RawItemChatData, TraitChatData } from "../base/data/index.ts";
import type { Rarity, Size, ZeroToTwo } from "../../data.ts";
import type { EffectSpinoff } from "../../rules/rule-element/effect-spinoff/spinoff.ts";
