...
import { ConsumablePF2e, MeleePF2e, PhysicalItemPF2e } from "types/pf2e/module/item/index.ts"
import { ItemSummaryData } from "types/pf2e/module/item/data/index.ts"
import { CoinsPF2e, IdentificationStatus, MystifiedData } from "types/pf2e/module/item/physical/index.ts"
...
declare class WeaponPF2e<TParent extends ActorPF2e | null = ActorPF2e | null> extends PhysicalItemPF2e<TParent> {
  ...
  clone(
    ...
    options: Omit<WeaponCloneOptions, "save"> & {
      save: true
    }
  ): Promise<this>
  clone(
