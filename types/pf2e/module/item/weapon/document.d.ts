...
import type { ConsumablePF2e, MeleePF2e, ShieldPF2e } from "../index.ts";
import { PhysicalItemPF2e } from "../index.ts";
import type { ItemSourcePF2e, RawItemChatData } from "../base/data/index.ts";
import type { NPCAttackTrait } from "../melee/types.ts";
import type { PhysicalItemConstructionContext } from "../physical/document.ts";
import { IdentificationStatus, MystifiedData } from "../physical/index.ts";
import type { RangeData } from "../types.ts";
import type { StrikeRuleElement } from "../../rules/rule-element/strike.ts";
