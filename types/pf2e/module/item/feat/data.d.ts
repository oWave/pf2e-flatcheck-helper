...
import type { SelfEffectReference, SelfEffectReferenceSource } from "../ability/index.ts";
import type { AbilityTraitToggles } from "../ability/trait-toggles.ts";
import type { ArmorCategory } from "../armor/types.ts";
import type { ActionType, BaseItemSourcePF2e, Frequency, FrequencySource, ItemSystemData, ItemSystemSource, ItemTraits } from "../base/data/system.ts";
import type { ClassTrait } from "../class/types.ts";
import type { WeaponCategory } from "../weapon/types.ts";
import type { OneToFour, OneToThree } from "../../data.ts";
