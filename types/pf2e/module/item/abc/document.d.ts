...
import type { AncestrySource, AncestrySystemData } from "../ancestry/data.ts";
import type { BackgroundSource, BackgroundSystemData } from "../background/data.ts";
import type { ClassSource, ClassSystemData } from "../class/data.ts";
