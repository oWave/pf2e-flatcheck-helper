...
declare const KINGDOM_SCHEMA: {
    ...
    build: SchemaField<{
        ...
        government: SchemaField<{
            skills: ArrayField<StringField<"exploration" | "defense" | "magic" | "agriculture" | "arts" | "boating" | "engineering" | "folklore" | "industry" | "intrigue" | "politics" | "scholarship" | "statecraft" | "trade" | "warfare" | "wilderness", "exploration" | "defense" | "magic" | "agriculture" | "arts" | "boating" | "engineering" | "folklore" | "industry" | "intrigue" | "politics" | "scholarship" | "statecraft" | "trade" | "warfare" | "wilderness", true, false, true>, ("exploration" | "defense" | "magic" | "agriculture" | "arts" | "boating" | "engineering" | "folklore" | "industry" | "intrigue" | "politics" | "scholarship" | "statecraft" | "trade" | "warfare" | "wilderness")[], ("exploration" | "defense" | "magic" | "agriculture" | "arts" | "boating" | "engineering" | "folklore" | "industry" | "intrigue" | "politics" | "scholarship" | "statecraft" | "trade" | "warfare" | "wilderness")[], false, false, true>;
            feat: StringField<`Compendium.${string}.Actor.${string}` | `Compendium.${string}.Item.${string}` | `Compendium.${string}.Macro.${string}` | `Compendium.${string}.Scene.${string}` | `Compendium.${string}.JournalEntry.${string}` | `Compendium.${string}.RollTable.${string}` | `Compendium.${string}.Cards.${string}` | `Compendium.${string}.Playlist.${string}` | `Compendium.${string}.Adventure.${string}`, `Compendium.${string}.Actor.${string}` | `Compendium.${string}.Item.${string}` | `Compendium.${string}.Macro.${string}` | `Compendium.${string}.Scene.${string}` | `Compendium.${string}.JournalEntry.${string}` | `Compendium.${string}.RollTable.${string}` | `Compendium.${string}.Cards.${string}` | `Compendium.${string}.Playlist.${string}` | `Compendium.${string}.Adventure.${string}`, true, true, true>;
            id: StringField<string, string, false, false>;
            name: StringField<string, string, true, false>;
            img: StringField<ImageFilePath, ImageFilePath, true, false>;
            description: StringField<string, string, true, false>;
        ...
        skills: SchemaField<Record<"exploration" | "defense" | "magic" | "agriculture" | "arts" | "boating" | "engineering" | "folklore" | "industry" | "intrigue" | "politics" | "scholarship" | "statecraft" | "trade" | "warfare" | "wilderness", SchemaField<{
            rank: foundry.data.fields.NumberField<ZeroToFour, ZeroToFour, true, false, true>;
        }, SourceFromSchema<{
            rank: foundry.data.fields.NumberField<ZeroToFour, ZeroToFour, true, false, true>;
        }>, ModelPropsFromSchema<{
            rank: foundry.data.fields.NumberField<ZeroToFour, ZeroToFour, true, false, true>;
        }>, true, false, true>>, SourceFromSchema<Record<"exploration" | "defense" | "magic" | "agriculture" | "arts" | "boating" | "engineering" | "folklore" | "industry" | "intrigue" | "politics" | "scholarship" | "statecraft" | "trade" | "warfare" | "wilderness", SchemaField<{
            rank: foundry.data.fields.NumberField<ZeroToFour, ZeroToFour, true, false, true>;
        }, SourceFromSchema<{
            rank: foundry.data.fields.NumberField<ZeroToFour, ZeroToFour, true, false, true>;
        }>, ModelPropsFromSchema<{
            rank: foundry.data.fields.NumberField<ZeroToFour, ZeroToFour, true, false, true>;
        }>, true, false, true>>>, ModelPropsFromSchema<Record<"exploration" | "defense" | "magic" | "agriculture" | "arts" | "boating" | "engineering" | "folklore" | "industry" | "intrigue" | "politics" | "scholarship" | "statecraft" | "trade" | "warfare" | "wilderness", SchemaField<{
            rank: foundry.data.fields.NumberField<ZeroToFour, ZeroToFour, true, false, true>;
        }, SourceFromSchema<{
            rank: foundry.data.fields.NumberField<ZeroToFour, ZeroToFour, true, false, true>;
        }>, ModelPropsFromSchema<{
