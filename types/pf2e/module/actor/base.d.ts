import { ActorAlliance, ActorDimensions, ActorInstances, ApplyDamageParams, AuraData, EmbeddedItemInstances, SaveType } from "./types.ts";
import type { AbstractEffectPF2e, ConditionPF2e, ContainerPF2e, PhysicalItemPF2e, ShieldPF2e } from "../item/index.ts";
...
import type { AppliedDamageFlag } from "../chat-message/index.ts";
import type { Size } from "../data.ts";
import { CombatantPF2e, EncounterPF2e } from "../encounter/index.ts";
import type { RuleElementSynthetics } from "../rules/index.ts";
import type { RuleElementPF2e } from "../rules/rule-element/base.ts";
