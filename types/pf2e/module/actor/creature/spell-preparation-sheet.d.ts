...
import type { ActorPF2e, CreaturePF2e } from "../index.ts";
...
declare class SpellPreparationSheet<TActor extends CreaturePF2e> extends ActorSheet<TActor, ItemPF2e> {
    ...
    itemRenderer: ItemSummaryRenderer<ActorPF2e<import("../../scene/token-document/document.ts").TokenDocumentPF2e<import("../../scene/document.ts").ScenePF2e | null> | null>, Application<ApplicationOptions> & {
        readonly actor: ActorPF2e<import("../../scene/token-document/document.ts").TokenDocumentPF2e<import("../../scene/document.ts").ScenePF2e | null> | null>;
    }>;
