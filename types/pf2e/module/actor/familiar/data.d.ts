import type { BaseCreatureSource, CreatureAttributes, CreatureDetails, CreatureLanguagesData, CreaturePerceptionData, CreatureResources, CreatureSaves, CreatureTraitsData, SkillData } from "../creature/data.ts";
